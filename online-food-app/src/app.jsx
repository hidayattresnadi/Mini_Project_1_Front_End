...
function App() {
    ...
    const renderView = () => {
        switch (view) {
            case 'menu':
                return (<>
                    <HomePage foods={foods} handleDeleteFood={handleDeleteFood} handleEditFood={handleEditFood} categories={categories} addFood={addFood} editFood={editFood} editingFood={editingFood} isFormFoodOpen={isFormFoodOpen} setIsFormFoodOpen={setIsFormFoodOpen}  />
                </>)
            case 'customer':
                return (<>
                    <CustomerPage customers={customers} handleDeleteCustomer={handleDeleteCustomer} handleEditCustomer={handleEditCustomer} addCustomer={addCustomer} editCustomer={editCustomer} editingCustomer={editingCustomer} isFormOpen={isFormOpen} setIsFormOpen={setIsFormOpen} />
                </>)
            case 'order':
                return (<>
                    <OrderPage foods={foods} customers={customers} saveOrder={saveOrder} categories={categories} orders={orders} getOrderStatus={getOrderStatus} />
                </>)
            default:
                return (<>
                    <HomePage foods={foods} handleDeleteFood={handleDeleteFood} handleEditFood={handleEditFood} categories={categories} addFood={addFood} editFood={editFood} editingFood={editingFood} isFormFoodOpen={isFormFoodOpen} setIsFormFoodOpen={setIsFormFoodOpen}  />
